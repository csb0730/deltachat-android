...
public class SpanUtil {
  ...
  public static CharSequence italic(CharSequence sequence, int length) {
    ...
    spannable.setSpan(new StyleSpan(android.graphics.Typeface.ITALIC), 0, length, Spannable.SPAN_INCLUSIVE_EXCLUSIVE);
    return spannable;
  }
  ...
  public static CharSequence small(CharSequence sequence) {
    ...
    spannable.setSpan(new RelativeSizeSpan(0.9f), 0, sequence.length(), Spannable.SPAN_INCLUSIVE_EXCLUSIVE);
    return spannable;
  }
  ...
  public static CharSequence bold(CharSequence sequence) {
    ...
    spannable.setSpan(new StyleSpan(Typeface.BOLD), 0, sequence.length(), Spannable.SPAN_INCLUSIVE_EXCLUSIVE);
    return spannable;
  }
  ...
  public static CharSequence color(int color, CharSequence sequence) {
    ...
    spannable.setSpan(new ForegroundColorSpan(color), 0, sequence.length(), Spannable.SPAN_INCLUSIVE_EXCLUSIVE);
    return spannable;
  }
}
